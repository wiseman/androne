...
import com.lemonodor.androne.R;
...
public class SplashActivity extends Activity {
    ...
    public void proceed() {
        startActivity(new Intent("com.lemonodor.androne.MAIN"));
        finish();
    }
    ...
    public void loadClojure() {
        new Thread(new Runnable(){
                ...
                public void run() {
                    ...
                    try {
                        Class.forName("com.lemonodor.androne.AndroneActivity");
                    } catch (ClassNotFoundException e) {
                        Log.e(TAG, "Failed loading AndroneActivity", e);
                    }
